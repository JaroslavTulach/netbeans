...
import org.netbeans.modules.htmlui.HtmlComponent;
...
final class JavaFxHtmlToolkit extends HtmlToolkit {
    ...
    public Object initHtmlDialog(String url, DialogDescriptor dd, JComponent ourPanel, Runnable onPageLoad, List<String> techIds) {
        ...
        HtmlToolkit.getDefault().load(webView, pageUrl, onPageLoad, loader, techIds.toArray());
        return webView;
    }
    ...
    public <C> C convertToComponent(Class<C> type, final URL pageUrl, ClassLoader loader, Runnable onPageLoad, List<String> techIds) throws IllegalStateException {
        if (type == Node.class) {
            ...
            HtmlToolkit.getDefault().load(wv, pageUrl, onPageLoad, loader, techIds.toArray());
            return type.cast(wv);
            ...
            HtmlToolkit.getDefault().execute(new Runnable() {
                ...
                public void run() {
                    WebView wv = new WebView();
                    HtmlToolkit.getDefault().load(wv, pageUrl, onPageLoad, l, techIds.toArray());
    ...
    public void load(Object webView, URL pageUrl, Runnable runnable, ClassLoader loader, Object[] ctx) {
        FXBrowsers.load((WebView)webView, pageUrl, runnable, loader, ctx);
    }
